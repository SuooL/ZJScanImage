...
+ (void)scanBigImageWithImageView:(UIImageView *)imageView view:(UIView*)view{
    ...
    fullImageView=[[UIImageView alloc] initWithFrame:CGRectMake(0, 0, YYScreenSize().width, YYScreenSize().height)];
    ...
    if (![fullImageView superview]) {
        ...
        [UIView animateWithDuration:0.5 animations:^{
            fullImageView.frame=CGRectMake(0, 0, YYScreenSize().width, YYScreenSize().height);
